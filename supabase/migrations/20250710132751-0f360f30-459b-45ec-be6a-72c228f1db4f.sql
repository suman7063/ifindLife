-- First, let's add a unique constraint to expert_accounts.auth_id
ALTER TABLE public.expert_accounts ADD CONSTRAINT expert_accounts_auth_id_unique UNIQUE (auth_id);

-- Now create the enhanced expert presence system with activity tracking
