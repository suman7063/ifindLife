        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center py-2 px-3 rounded-lg transition-all duration-200 focus-visible:ring-2 focus-visible:ring-ifind-teal ${
                active 
                  ? 'text-ifind-teal' 
