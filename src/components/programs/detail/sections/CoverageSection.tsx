...
interface CoverageSectionProps {
  whatItCovers: ProgramDetail['whatItCovers'];
  coverage?: ProgramDetail['coverage'];
}

const CoverageSection: React.FC<CoverageSectionProps> = ({ whatItCovers, coverage }) => {
  // If we have structured coverage data, use it; otherwise fall back to whatItCovers
  if (coverage) {
    return (
