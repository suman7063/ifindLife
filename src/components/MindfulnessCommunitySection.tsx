      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center md:space-x-8">
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0">
            <img 
              src="/lovable-uploads/6c427c55-7a38-4dad-8c60-cc782cbc5bd7.png" 
          ...
          <div className="w-full md:w-1/2">
            <h2 className="text-3xl font-bold mb-4 text-center md:text-left">Join Our Mindfulness Community</h2>
            ...
            <div className="space-y-4">
              <Button 
                className="w-full bg-ifind-teal hover:bg-ifind-teal/90 text-white flex items-center justify-center gap-2"
              ...
              <Button 
                className="w-full bg-ifind-purple hover:bg-ifind-purple/90 text-white flex items-center justify-center gap-2"
                onClick={() => window.open('https://discord.gg/xyz', '_blank')}
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              ...
              <Button 
                ...
                onClick={() => window.open('https://t.me/xyz', '_blank')}  
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
