      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          <div className="w-full">
            <img src="/lovable-uploads/7f8f5b16-65a3-4c35-b438-d5269980e6db.png" alt="Happy community members" className="rounded-lg shadow-lg w-full h-64 md:h-80 lg:h-96 object-cover" />
          </div>
          ...
          <div className="w-full flex flex-col justify-center space-y-6">
            ...
            <div className="bg-white rounded-lg p-6 border border-purple-200 flex-1 flex flex-col justify-center">
              ...
              <NewsletterSubscription placeholder="Your email address" buttonLabel="Join" className="flex gap-2" />
            </div>
            ...
            <div className="bg-white rounded-lg p-6 border border-teal-200 flex-1 flex flex-col justify-center">
              ...
              <Button onClick={handleWhatsAppJoin} className="w-full bg-teal-500 hover:bg-teal-600 text-white flex items-center justify-center gap-2 text-sm">
