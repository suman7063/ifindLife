      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Professional listening experts with advanced training in therapeutic communication and emotional support. 
            They provide deeper insights and professional guidance while maintaining the core principles of compassionate listening.
          </p>
        </div>
        ...
        <div className="bg-card/50 backdrop-blur-sm rounded-lg p-8 mb-12 border">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              <h3 className="font-medium mb-2">Professional Insight</h3>
              <p className="text-sm text-muted-foreground">Expert-level understanding of emotional patterns and communication</p>
            </div>
            <div className="text-center">
              <h3 className="font-medium mb-2">Therapeutic Techniques</h3>
              <p className="text-sm text-muted-foreground">Advanced listening skills with therapeutic foundations</p>
            </div>
            <div className="text-center">
              <h3 className="font-medium mb-2">Deeper Guidance</h3>
              <p className="text-sm text-muted-foreground">Professional guidance while maintaining supportive listening approach</p>
            </div>
          </div>
        </div>
