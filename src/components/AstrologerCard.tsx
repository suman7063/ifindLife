  ...
  return (
    <Card className="overflow-hidden transition-all duration-300 hover:shadow-lg group border border-border/50 hover:border-astro-light-purple/50">
      ...
      <CardFooter className="px-4 py-3 border-t flex gap-2">
        <Button variant="outline" className="flex-1 border-astro-purple text-astro-purple hover:bg-astro-purple hover:text-white transition-all">
          <PhoneCall className="h-4 w-4 mr-1" />
          Call
        </Button>
        <Button className="flex-1 bg-astro-purple hover:bg-astro-violet transition-colors">
