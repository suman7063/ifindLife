...
const ProgramsForWellnessSeekers: React.FC = () => {
  ...
  // Sample wellness programs with unique images
            ...
            <TabsContent value="wellness" className="space-y-8">
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <Button
                  ...
                  className={selectedCategory === 'all' ? 'bg-ifind-teal hover:bg-ifind-teal/90' : ''}
                >
                  All Programs
                </Button>
                <Button
                  ...
                  className={selectedCategory === 'quick-ease' ? 'bg-ifind-teal hover:bg-ifind-teal/90' : ''}
                >
                  Quick-Ease Programs
                </Button>
                <Button
                  ...
                  className={selectedCategory === 'resilience-building' ? 'bg-ifind-teal hover:bg-ifind-teal/90' : ''}
                >
                  Resilience Building Programs
                </Button>
                <Button
                  ...
                  className={selectedCategory === 'super-human' ? 'bg-ifind-teal hover:bg-ifind-teal/90' : ''}
                >
                  Super Human Programs
                </Button>
                <Button
                  ...
                  className={selectedCategory === 'favorites' ? 'bg-ifind-teal hover:bg-ifind-teal/90' : ''}
                >
                  Favorite Programs
                </Button>
              </div>
