...
const Referral: React.FC = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // Load user's referrals if authenticated
        if (isAuthenticated && userProfile?.id) {
          const userReferrals = await fetchUserReferrals(userProfile.id);
      ...
      <>
        ...
        <Container className="py-12">
          ...
          <div className="text-center">
            <p className="mb-4">Please login to view and share your referral code.</p>
            <a href="/user-login" className="text-primary hover:underline">Login now</a>
          </div>
        </Container>
      </>
    );
  ...
  return (
    <>
      ...
      <PageHeader 
        title="Referral Program" 
        subtitle="Invite friends to iFindLife and earn rewards" 
      />
      <Container className="py-12">
        <Tabs defaultValue="info">
          ...
          <TabsContent value="info" className="space-y-6">
            ...
            <ReferralCard userProfile={userProfile} settings={settings} />
